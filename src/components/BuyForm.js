...
const BuyForm = ({ buyTimeLine, currentForm, setCurrentForm }) => {
  const {
    web3,
    account,
    daiToken,
  ...
  return (
    <FormContainer onSubmit={submit}>
      ...
      <ExtendDiv>
        <InputBalance
          disabled
          value="Total Wallet Balance"
          style={{ fontSize: "14px", color: "rgba(137, 137, 137, 1)" }}
        />
        <DD_Div>
      ...
      <Div>
        <ActualBalance
          ...
          value={
            selectInp == "tl"
              ? displayWei(timeLineBalance)
              : displayWei(ethBalance)
          }
          placeholder="6,300"
          style={{
            fontSize: "48px",
