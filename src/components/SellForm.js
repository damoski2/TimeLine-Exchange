...
const SellForm = ({ ethBalance, daiTokenBalance, timeLineBalance, sellTimeLine, currentForm, setCurrentForm}) => {
    ...
    return (
        <FormContainer onSubmit={submit} >
            <HeadingDiv>
                <p style={{ color: '#000000', fontSize: '20px', alignSelf: 'center', margin:'0', lineHeight: '24.2px'}} >Sell Currency</p>
                <HeadingButton onClick={changeForm} >Buy</HeadingButton>
            </HeadingDiv>
            <ExtendDiv>
            ...
            <Div style={{ marginTop: '2em' }} >
                <EXdiv>
                    ...
                    Exchange rate: 1 TL = 0.222 Dai
                    </P>
                </EXdiv>
            </Div>
            <Div style={{ marginTop: '2em' }}  >
                <SubmitBtn>Exchange</SubmitBtn>
            </Div>
        </FormContainer>
    )
}
